...
```sh
uv run src/mdverse_entity_norm/scripts/normalize_simulation_time.py --raw_simu_times_file data/STIME.txt --normalized_simulation_time results/norm_simu_times/normalized_simulation_time_gpt.json --ground_truth_file data/STIME_ground_truth.json --runs 10 --model_evaluation_file results/norm_simu_times/model_evaluation.tsv
```
